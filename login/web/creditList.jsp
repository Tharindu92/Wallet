  ...
  <table width="954" border="5" cellpadding="5">
    ...
    <%       
           ...
           String temp =current.getUsername();
            ...
            ResultSet resultset = statement.executeQuery("SELECT * FROM Wallet_theuntoucha8081.Transactions WHERE TLender='" + temp +"'") ; 
        %>
        ...
        <TABLE width="954" BORDER="1" cellpadding="5">
            ...
            <TR>
                ...
                <TD  width="144" scope="col"> <%= resultset.getString(5) %></TD>
...
<div id="title"><strong>Credit List of              
